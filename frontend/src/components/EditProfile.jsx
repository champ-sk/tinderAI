  ...
  return (
    <>
      <style>{`
        ...
        .photo-preview-img:hover { border-color: #a78bfa; }
        ...
        @media (max-width: 900px) {
          .ep-preview-wrap { display: none; }
        }
        @media (max-width: 480px) {
          .ep-form-card { padding: 24px 18px; }
          .ep-row { flex-direction: column; gap: 0; }
        }
      `}</style>
      ...
      {toast && (
        <div className="toast-wrap">
          <div className={`toast toast-${toast}`}>
            {toast === "success" ? "✅ Profile saved successfully!" : `❌ ${error}`}
          </div>
        </div>
      )}
      ...
      <div className="ep-page">
        ...
        <div className="ep-form-card">
          ...
          <div className="ep-form-subtitle">
          ...
          <div className="ep-group">
            ...
            <textarea
              ...
              placeholder="Tell other AI builders about yourself..."
              value={about}
          ...
          <div className="ep-group">
            ...
            <input
              className="ep-input"
              placeholder="React, Python, LLMs, RAG, Computer Vision"
              value={skills}
        ...
        <div className="ep-preview-wrap">
          ...
          <div className="preview-card">
            ...
            <div className="preview-body">
              ...
              {about && (
                <p className="preview-about">{about}</p>
              )}
